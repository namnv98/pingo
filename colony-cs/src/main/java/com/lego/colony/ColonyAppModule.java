...
public class ColonyAppModule extends AbstractModule {
  ...
  @Provides
  @Singleton
  private ConversationMembershipRegistry channelMembershipRegistry(PgPool pgPool) {
  ...
  private RestApiVerticle restApiVerticle(
      ChatSessionManager sessionManager, MessageHistoryRegistry history, UserRegistry users, JwtHelper jwtHelper, ConversationMembershipRegistry membership) {
