...
public final class ArrayUtils {
    ...
    public static <T> T[] concat(final T[] array1, T... array2) {
        if (array2 == null || array2.length == 0)
            return clone(array1);
        int length = array1.length + array2.length;
        Class<?> tCls = array1.getClass().getComponentType();
        T[] results = (T[]) Array.newInstance(tCls, length);
    ...
    public static Object toPrimitiveArray(List<?> list, Class<?> clazz) {
        ...
        throw new LegoException("Unsupported type: " + clazz.getName());
    }
