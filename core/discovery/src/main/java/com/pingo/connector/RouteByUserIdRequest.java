...
import com.pingo.discovery.router.RoutingKey;
...
@Setter
@Getter
public class RouteByUserIdRequest implements LegoRequest<Buffer>, RoutingKey {
  ...
  @Override
  public int hash() {
    return UUIDsHashHelper.getInstance().hash(userId);
  }
}
