 ...
 * đây (xem {@link #onRoutedMessage}). Payload EventBus giờ là bytes protobuf ({@code Frame.toByteArray()})
 * thay vì JSON — cùng envelope {@code Frame} dùng cho cả chặng harbor↔colony (xem
 * {@code discovery/src/main/proto/link.proto}), không còn 1 định dạng riêng cho việc forward
 * xuyên node nữa. Dùng bởi {@code com.lego.colony.ws.ChatSessionManager}.
 */
@Slf4j
