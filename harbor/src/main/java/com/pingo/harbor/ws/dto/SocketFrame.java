...
public class SocketFrame {
  ...
  /** User id người nhận — chỉ tiện lợi hiển thị cho MESSAGE dạng DM, KHÔNG dùng để route (xem {@link #conversationId}). */
  private String toUserId;

  /**
   * Id conversation (DM hoặc group) — bắt buộc với MESSAGE/SUBSCRIBE, là routing key thật sự. Với
   * DM, harbor tự suy ra bằng {@code ConversationIds.dmId(fromUserId, toUserId)} nếu client không gửi field này.
   */
