 ...
 * cùng pod (xem {@code BackendLinkGateway#clients}), nên không còn cần tự chia shard/dùng chung 1
...
public class BackendStream {
  ...
  private final SockjsSocket session;
  ...
  public BackendStream(String podName, SockjsSocket session, GrpcClientRequest<Frame, Frame> request) {
   ...
   * {@code BackendLinkGateway#doConnect}) rồi mới resolve trễ, chưa kịp ghi gì. Dùng {@code cancel()}
