    ...
    if (runningInK8s) {
      var k8sClientConfig =
          K8sClientConfig.builder()
              ...
              .build();
      // 8086 = admHttp cua colony (HealthCheckVerticle's /healthcheck) -- tu khi RestApiVerticle
      // tach sang hall, colony khong con serve gi tren 8085 (publicHttp cu) nua.
      var healthcheckPort = Integer.parseInt(StringUtils.defaultIfBlank(System.getenv(HEALTHCHECK_PORT_ENV), "8086"));
